...
public class RoomTypeTest
{
    ...
    void buildRoomTypeSuccessfully() {
        RoomType roomType = RoomTypeFactory.buildRoomType(1L, "Deluxe", 150.00);
    ...
    void buildRoomTypeFailsWhenNameIsEmpty() {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            RoomTypeFactory.buildRoomType(1L, "", 150.00);
        });
    ...
    void buildRoomTypeFailsWhenPriceIsNegative() {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            RoomTypeFactory.buildRoomType(1L, "Deluxe", -150.00);
        });
    ...
    void buildGeneratedId() {
        RoomType roomType = RoomTypeFactory.buildRoomType(null, "Standard", 100.00);
        assertNotNull(roomType);
