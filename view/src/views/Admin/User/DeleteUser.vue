...
// Removed the default base URL setting for Axios
// Removed the Axios interceptor for adding Authorization headers
...
export default {
  ...
  methods: {
    fetchUsers() {
      axios
          .get('/api/admin/users/all') // Removed Authorization headers
          .then((response) => {
    ...
    deleteUser(userId) {
      axios
          .delete(`/api/admin/users/delete/${userId}`) // Removed Authorization headers
          .then((response) => {
            this.fetchUsers();
